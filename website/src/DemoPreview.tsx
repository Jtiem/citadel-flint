...
const demos: DemoEntry[] = [{
  id: 'banner-compliant',
  label: '01 — Banner (Compliant)',
  render: () => <BannerCompliant {...bannerProps} />
}, {
  id: 'banner-broken',
  label: '01 — Banner (Broken)',
  render: () => <BannerBroken {...bannerProps} />
}, {
  id: 'buggy',
  label: '02 — Data Table (Buggy)',
  render: () => <BuggyComponent {...dataTableProps} />
}, {
  id: 'drift',
  label: '03 — Pricing (Drift)',
  render: () => <DriftComponent {...pricingProps} />
}];
    ...
    fontFamily: 'system-ui, sans-serif'
      ...
      gap: 16
        ...
        gap: 8
          ...
          {demos.map(d => <button key={d.id} onClick={() => setActive(d.id)} style={{
          padding: '6px 12px',
          borderRadius: 6,
          border: 'none',
          cursor: 'pointer',
