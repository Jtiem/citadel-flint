...
import { bF as getDefaultExportFromCjs } from "./main-CXyorJdQ.js";
...
function requireJiti() {
  ...
  (() => {
    ...
    (() => {
      ...
      const le = require$$1, ue = fs__default;
      const fe = /^\.?\//;
      ...
      const isAbsolute = function(e3) {
        ...
        return s2;
      }, _e = require$$3, Ee = assert, be = process$1, Se = path, ke = v8, we = require$$8, Ie = new Set(le.builtinModules);
...
Default "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
      ...
      std_env_dist_n(gt.CI) || false !== yt.ci;
