import { e as error, a as relativeId, l as logImplicitDependantIsNotIncluded, L as LOGLEVEL_WARN, b as logCircularDependency, d as logMissingExport, f as LOGLEVEL_INFO, g as logInvalidOption, U as URL_WATCH, h as logPluginError, i as logInputHookInOutputPlugin, E as EMPTY_OBJECT, w as warnDeprecation, j as URL_LOAD, k as logBadLoader, m as logInconsistentImportAttributes, n as logExternalModulesCannotBeTransformedToModules, o as isAbsolute, p as logInternalIdCannotBeExternal, q as isRelative, s as logUnresolvedImport, t as logUnresolvedImportTreatedAsExternal, u as logExternalSyntheticExports, v as logUnresolvedEntry, x as logUnresolvedImplicitDependant, y as logExternalModulesCannotBeIncludedInManualChunks, z as logEntryCannotBeExternal, A as logImplicitDependantCannotBeExternal, B as logMissingEntryExport, C as logSyntheticNamedExportsNeedNamespaceExport, D as logInvalidFormatForTopLevelAwait, F as nativeExports, T as TemplateLiteral$1, G as Literal$1, H as logDuplicateExportError, I as logRedeclarationError, J as locate, K as logInvalidSourcemapForError, M as augmentCodeLocation, N as logMissingJsxExport, O as logNamespaceConflict, P as logAmbiguousExternalNamespaces, Q as logShimmedExport, R as parseAst, S as logModuleParseError, V as logMissingFileOrDirOption, W as LOGLEVEL_ERROR, X as logLevelPriority, Y as EMPTY_SET, Z as logUnknownOption, _ as logInvalidFunctionPluginHook, $ as logInvalidLogPosition, a0 as LOGLEVEL_DEBUG, a1 as EMPTY_ARRAY, a2 as URL_JSX, a3 as logFailedValidation, a4 as logNoAssetSourceSet, a5 as logFileReferenceIdNotFoundForFilename, a6 as logAssetReferenceIdNotFoundForSetSource, a7 as logAssetSourceAlreadySet, a8 as logInvalidRollupPhaseForChunkEmission, a9 as isPathFragment, aa as BLANK, ab as logInvalidAddonPluginHook, ac as logInvalidSetAssetSourceCall, ad as logUnusedExternalImports, ae as logImportAttributeIsInvalid, af as logImportOptionsAreInvalid, ag as logCircularReexport, ah as ExpressionStatement$1, ai as Identifier$1, aj as logThisIsUndefined, ak as logCannotCallNamespace, al as logFirstSideEffect, am as logInvalidAnnotation, an as getRollupError, ao as logParseError, ap as Property$1, aq as RestElement$1, ar as ArrowFunctionExpression$1, as as normalize, at as logIllegalImportReassignment, au as CallExpression$1, av as Program$1, aw as logModuleLevelDirective, ax as logEval, ay as ReturnStatement$1, az as logConstVariableReassignError, aA as getAstBuffer, aB as logChunkInvalid, aC as augmentLogMessage, aD as printQuotedStringList, aE as URL_TREESHAKE, aF as URL_TREESHAKE_MODULESIDEEFFECTS, aG as ExportDefaultDeclaration$1, aH as URL_GENERATEBUNDLE, aI as logChunkNotGeneratedForFileName, aJ as logAssetNotFinalisedForFileName, aK as logFileNameConflict, aL as logNoTransformMapOrAstWithoutCode, aM as URL_TRANSFORM, aN as ANNOTATION_KEY, aO as INVALID_ANNOTATION_KEY, aP as AwaitExpression$1, aQ as MemberExpression$1, aR as FunctionExpression$1, aS as getImportPath, aT as BlockStatement$1, aU as logDuplicateArgumentNameError, aV as VariableDeclarator$1, aW as URL_OUTPUT_FORMAT, aX as URL_OUTPUT_DIR, aY as URL_OUTPUT_SOURCEMAPFILE, aZ as URL_OUTPUT_AMD_ID, a_ as logCannotAssignModuleToChunk, a$ as logCyclicCrossChunkReexport, b0 as getAliasName, b1 as logUnexpectedNamedImport, b2 as relative$1, b3 as logUnexpectedNamespaceReexport, b4 as logEmptyChunk, b5 as logAnonymousPluginCache, b6 as logDuplicatePluginName, b7 as StaticBlock$1, b8 as CatchClause$1, b9 as convertAnnotations, ba as FIXED_STRINGS, bb as convertNode$1, bc as logCannotEmitFromOptionsHook, bd as logCircularChunk, be as logOptimizeChunkStatus, bf as logIncompatibleExportOptionValue, bg as logMixedExport, bh as logAddonNotGenerated, bi as logMissingNameOptionForUmdExport, bj as logIllegalIdentifierAsName, bk as logMissingNameOptionForIifeExport, bl as logMissingGlobalName, bm as ObjectExpression$1, bn as logConflictingSourcemapSources, bo as logSourcemapBroken, bp as URL_OUTPUT_INLINEDYNAMICIMPORTS, bq as URL_PRESERVEENTRYSIGNATURES, br as URL_OUTPUT_GENERATEDCODE, bs as URL_OUTPUT_EXTERNALIMPORTATTRIBUTES, bt as isValidUrl, bu as addTrailingSlashIfMissed, bv as URL_OUTPUT_SOURCEMAPBASEURL, bw as URL_OUTPUT_MANUALCHUNKS, bx as logInvalidExportOptionValue, by as URL_OUTPUT_AMD_BASEPATH, bz as logMissingNodeBuiltins, bA as logReservedNamespace, bB as URL_OUTPUT_INTEROP, bC as logAlreadyClosed } from "./main-CXyorJdQ.js";
import { basename, extname, resolve, dirname, relative } from "node:path";
import { posix, isAbsolute as isAbsolute$1, resolve as resolve$1, win32 } from "path";
import process$1, { env } from "node:process";
import { performance } from "node:perf_hooks";
import * as fsp from "node:fs/promises";
function _mergeNamespaces$1(n2, m) {
...
const UnknownKey = /* @__PURE__ */ Symbol("Unknown Key");
const UnknownNonAccessorKey = /* @__PURE__ */ Symbol("Unknown Non-Accessor Key");
const UnknownInteger = /* @__PURE__ */ Symbol("Unknown Integer");
const UnknownWellKnown = /* @__PURE__ */ Symbol("Unknown Well-Known");
const SymbolToStringTag = /* @__PURE__ */ Symbol("Symbol.toStringTag");
const SymbolDispose = /* @__PURE__ */ Symbol("Symbol.asyncDispose");
const SymbolAsyncDispose = /* @__PURE__ */ Symbol("Symbol.dispose");
const SymbolHasInstance = /* @__PURE__ */ Symbol("Symbol.hasInstance");
...
const EntitiesKey = /* @__PURE__ */ Symbol("Entities");
...
const UnknownValue = /* @__PURE__ */ Symbol("Unknown Value");
const UnknownTruthyValue = /* @__PURE__ */ Symbol("Unknown Truthy Value");
const UnknownFalsyValue = /* @__PURE__ */ Symbol("Unknown Falsy Value");
...
const PureFunctionKey = /* @__PURE__ */ Symbol("PureFunction");
...
class Variable extends ExpressionEntity {
  ...
  addUsedPlace(usedPlace) {
    const isFunctionCall = usedPlace.parent.type === CallExpression$1 && usedPlace.parent.callee === usedPlace;
...
const IS_SKIPPED_CHAIN = /* @__PURE__ */ Symbol("IS_SKIPPED_CHAIN");
...
const isInteger = (property2) => typeof property2 === "string" && /^\d+$/.test(property2);
...
const OBJECT_PROTOTYPE = new ObjectEntity(/* @__PURE__ */ new Map([
...
const ARRAY_PROTOTYPE = new ObjectEntity(/* @__PURE__ */ new Map([
...
const ValueProperties = /* @__PURE__ */ Symbol("Value Properties");
...
const tdzVariableKinds = /* @__PURE__ */ new Set(["class", "const", "let", "var", "using", "await using"]);
...
const UNKNOWN_DEOPTIMIZED_FIELD = /* @__PURE__ */ new Set([UnknownKey]);
const EMPTY_PATH_TRACKER = new EntityPathTracker();
const UNKNOWN_DEOPTIMIZED_ENTITY = /* @__PURE__ */ new Set([UNKNOWN_EXPRESSION]);
class ParameterVariable extends LocalVariable {
  ...
  updateKnownValue(argument) {
    ...
    if (this.knownValue === argument || this.knownValue instanceof Identifier && argument instanceof Identifier && this.knownValue.variable === argument.variable) {
      return;
    }
...
const loopOverNamespaces = (body, useForEach, t, { _, cnst, getDirectReturnFunction, getFunctionIntro, n: n2 }) => {
  if (useForEach) {
    const [left, right] = getDirectReturnFunction(["e"], {
...
const copyOwnPropertyLiveBinding = (t, index, { _, cnst, getDirectReturnFunction, n: n2 }) => {
...
const copyPropertyLiveBinding = (t, index, { _, cnst, getDirectReturnFunction, n: n2 }) => {
  const [left, right] = getDirectReturnFunction([], {
    functionReturn: true,
    lineBreakIndent: null,
    name: null
...
const copyPropertyStatic = (_t, index, { _, n: n2 }) => `${index}n[k]${_}=${_}e[k];${n2}`;
...
const getResolveUrl = (path, asObject, URL2 = "URL") => `new ${URL2}(${path})${asObject ? "" : ".href"}`;
const getRelativeUrlFromDocument = (relativePath, asObject, umd2 = false) => getResolveUrl(`'${escapeId(relativePath)}', ${umd2 ? `typeof document === 'undefined' ? location.href : ` : ""}document.currentScript && document.currentScript.tagName.toUpperCase() === 'SCRIPT' && document.currentScript.src || document.baseURI`, asObject);
const getGenericImportMetaMechanism = (getUrl) => (property2, { chunkId }) => {
...
const getUrlFromDocument = (chunkId, umd2 = false) => `${umd2 ? `typeof document === 'undefined' ? location.href : ` : ""}(${DOCUMENT_CURRENT_SCRIPT} && ${DOCUMENT_CURRENT_SCRIPT}.tagName.toUpperCase() === 'SCRIPT' && ${DOCUMENT_CURRENT_SCRIPT}.src || new URL('${escapeId(chunkId)}', document.baseURI).href)`;
...
class ExternalChunk {
  ...
  getFileName() {
    ...
    return this.fileName = (typeof paths === "function" ? paths(this.id) : paths[this.id]) || (this.renormalizeRenderPath ? normalize(relative(this.inputBase, this.id)) : this.id);
  }
...
const getDefineProperty = (name, needsLiveBinding, t, { _, getDirectReturnFunction, n: n2 }) => {
  if (needsLiveBinding) {
    const [left, right] = getDirectReturnFunction([], {
      functionReturn: true,
      lineBreakIndent: null,
...
const keypath = (keypath2, getPropertyAccess) => keypath2.split(".").map(getPropertyAccess).join("");
...
const getStarExcludesBlock = (starExcludes, t, { _, cnst, getObject, n: n2 }) => {
  if (starExcludes) {
...
const getImportBindingsBlock = (importBindings, t, { _, n: n2 }) => importBindings.length > 0 ? `${n2}${t}var ${importBindings.join(`,${_}`)};` : "";
...
const getSyntheticExportsBlock = (exports$1, t, snippets) => getExportsBlock(exports$1.filter((expt) => expt.expression).map((expt) => ({ name: expt.exported, value: expt.local })), t, snippets);
const getMissingExportsBlock = (exports$1, t, snippets) => getExportsBlock(exports$1.filter((expt) => expt.local === MISSING_EXPORT_SHIM_VARIABLE).map((expt) => ({ name: expt.exported, value: MISSING_EXPORT_SHIM_VARIABLE })), t, snippets);
...
const extractAssignedNames = function extractAssignedNames2(param) {
  const names = [];
...
const normalizePath = function normalizePath2(filename) {
...
const createFilter$1 = function createFilter(include, exclude, options) {
  const getMatcher = (id) => id instanceof RegExp ? id : {
    test: (what) => {
      const pattern = getMatcherString$1(id);
...
class ArrowFunctionExpression extends FunctionBase {
  ...
  onlyFunctionCallUsed() {
    const isIIFE = this.parent.type === CallExpression$1 && this.parent.callee === this;
...
const UNASSIGNED$1 = /* @__PURE__ */ Symbol("Unassigned");
...
class FunctionExpression extends FunctionNode {
  ...
  onlyFunctionCallUsed() {
    const isIIFE = this.parent.type === CallExpression$1 && this.parent.callee === this && (this.id === null || this.id.variable.getOnlyFunctionCallUsed());
    return isIIFE || super.onlyFunctionCallUsed();
  }
  render(code, options, { renderedSurroundingElement } = BLANK) {
    super.render(code, options);
    ...
    if (["classic", "automatic"].includes(jsxMode)) {
      ...
      if (!(jsxMode === "automatic" && key === "key")) {
        ...
        if (value) {
          ...
          if (value instanceof Literal && typeof value.value === "string" && value.value.includes("\n")) {
...
class Property extends MethodBase {
  ...
  getPathInProperty(destructuredInitPath) {
    return destructuredInitPath.at(-1) === UnknownKey ? destructuredInitPath : (
      ...
      this.computed ? [...destructuredInitPath, UnknownKey] : this.key instanceof Identifier ? [...destructuredInitPath, this.key.name] : [...destructuredInitPath, String(this.key.value)]
    );
  }
}
...
class ThisExpression extends NodeBase {
  ...
  includePath(path, context) {
    ...
    if (functionScope && functionScope.functionNode.parent instanceof Property && functionScope.functionNode.parent.parent instanceof ObjectExpression) {
...
const UNASSIGNED = /* @__PURE__ */ Symbol("Unassigned");
...
const bufferParsers = [
  ...
  function catchClause(node, position, buffer) {
    ...
    const parameter = node.param = parameterPosition === 0 ? null : convertNode(node, scope, parameterPosition, buffer);
  ...
  function classBody(node, position, buffer) {
    ...
    if (bodyPosition) {
      ...
      for (let index = 0; index < length; index++) {
        ...
        body[index] = convertNode(node, buffer[nodePosition] !== 79 && (buffer[nodePosition + 3] & /* the static flag is always first */
  ...
  function classDeclaration(node, position, buffer) {
    ...
    node.id = idPosition === 0 ? null : convertNode(node, scope.parent, idPosition, buffer);
...
const sourceMapCache = /* @__PURE__ */ new WeakMap();
...
const ATTRIBUTE_KEYWORDS = /* @__PURE__ */ new Set(["assert", "with"]);
...
const getPropertyKey = (property2) => {
...
class Module {
  ...
  async setSource({ ast, code, customTransformCache, originalCode, originalSourcemap, resolvedIds, sourcemapChain, transformDependencies, transformFiles, safeVariableNames, ...moduleOptions }) {
    ...
    if (ast) {
      ...
      const astBuffer = await nativeExports.parseAsync(code, false, this.options.jsx !== false);
      timeStart("generate ast", 3);
  ...
  addDynamicImport(node) {
    ...
    } else if (argument.type === Literal$1 && typeof argument.value === "string") {
...
const lowercaseBundleKeys = /* @__PURE__ */ Symbol("bundleKeys");
...
const NON_ASSET_EXTENSIONS = /* @__PURE__ */ new Set([
  ".js",
  ".jsx",
  ".ts",
  ".tsx",
  ...
  getRenderedDependencies() {
    ...
    for (const dependency of this.dependencies) {
      ...
      renderedDependencies.set(dependency, {
        ...
        importPath,
        imports,
        isChunk: dependency instanceof Chunk2,
...
function collapseSourcemaps(file, map, modules, bundleSourcemapChain, excludeContent, log) {
  ...
  if (file) {
    ...
    sources = sources.map((source2) => relative(directory, source2));
    file = basename(file);
  }
  for (const module of modules) {
...
let textEncoder;
const getHash64 = (input) => nativeExports.xxhashBase64Url(ensureBuffer(input));
const getHash36 = (input) => nativeExports.xxhashBase36(ensureBuffer(input));
const getHash16 = (input) => nativeExports.xxhashBase16(ensureBuffer(input));
const hasherByType = {
  base36: getHash36,
  base64: getHash64,
  hex: getHash16
...
async function resolveId(source, importer, preserveSymlinks, pluginDriver, moduleLoaderResolveId, skip, customOptions, isEntry, attributes, importerAttributes, fs2) {
  ...
  if (importer !== void 0 && !isAbsolute(source) && source[0] !== ".")
    return null;
  return addJsExtensionIfNecessary(importer ? resolve(dirname(importer), source) : resolve(source), preserveSymlinks, fs2);
}
...
const emittedFileTypes = /* @__PURE__ */ new Set(["chunk", "asset", "prebuilt-chunk"]);
...
const rejectByPluginDriver = /* @__PURE__ */ new Map();
...
const fs = /* @__PURE__ */ _mergeNamespaces$1({
  __proto__: null
}, [fsp]);
...
const ALLOWED_INTEROP_TYPES = /* @__PURE__ */ new Set([
  "compat",
  "auto",
  "esModule",
  "default",
...
const EMPTY_COMMAND_OPTIONS = { external: [], globals: void 0 };
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-BrZ6gcfX.js");
