import { c as createFilter$1, r as rollupInternal, g as getDefaultExportFromCjs, a as getAugmentedNamespace, f as fseventsImporter } from "./rollup-DxSDdiwt.js";
import path from "node:path";
import process$1 from "node:process";
import require$$0$1__default from "path";
...
function requireConstants$3() {
  ...
  const path2 = require$$0$1__default;
  const WIN_SLASH = "\\\\/";
...
function requireReaddirp() {
  ...
  const sysPath = require$$0$1__default;
...
function requireGlobParent() {
  ...
  var pathPosixDirname = require$$0$1__default.posix.dirname;
...
function requireConstants() {
  ...
  (function(exports$1) {
    const { sep } = require$$0$1__default;
