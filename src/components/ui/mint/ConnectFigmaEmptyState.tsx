    ...
    if (figmaConnected) {
        return (
            <div
                ...
                data-testid="connect-figma-empty-state"
                data-variant="connected-no-tokens"
            ...
            >
                ...
                <p className="max-w-[320px] text-xs text-zinc-500">
                ...
                <button
                    ...
                    disabled={isPulling}
                    data-testid="connect-figma-pull-cta"
                    aria-label="Pull tokens from Figma"
                    className={[
    ...
    return (
        ...
        >
            ...
            <button
                ...
                data-testid="connect-figma-connect-cta"
            ...
            <button
                ...
                data-testid="connect-figma-import-link"
                aria-label="Import tokens manually from a JSON file"
                className={[
                    'text-[11px] text-zinc-400 underline-offset-2 hover:text-zinc-200 hover:underline',
                    'focus:outline-none focus:ring-1 focus:ring-indigo-400/50 rounded',
                ].join(' ')}
            >
