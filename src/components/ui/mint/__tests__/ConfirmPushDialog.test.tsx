...
describe('ConfirmPushDialog', () => {
    it('renders nothing when isOpen=false', () => {
        const { container } = render(<ConfirmPushDialog {...makeProps({ isOpen: false })} />)
    ...
    it('renders localEditCount in the dialog body (plural)', () => {
        render(<ConfirmPushDialog {...makeProps({ localEditCount: 12 })} />)
    ...
    it('renders the singular form when localEditCount=1', () => {
        render(<ConfirmPushDialog {...makeProps({ localEditCount: 1 })} />)
    ...
    it('fires onConfirm exactly once when user clicks Confirm', () => {
        ...
        render(<ConfirmPushDialog {...makeProps({ onConfirm, onCancel })} />)
