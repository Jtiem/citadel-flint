                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3 p-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            aria-label="Collection name for imported tokens"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            aria-label="Paste W3C DTCG JSON token file"
                        />
                    </div>

                    {error && (
                        <p className="rounded bg-red-900/30 px-2 py-1.5 text-[11px] text-red-400" role="alert">
                            {error}
                        </p>
                    )}
        ...
        <div className="relative flex h-full flex-col text-zinc-300">
                ...
                <div className="ml-auto flex items-center gap-1.5">
                    ...
                    <div className="flex items-center rounded border border-zinc-700 bg-zinc-800/60" role="radiogroup" aria-label="Token view mode">
                        <button
                            ...
                            className={`rounded-l px-1.5 py-1 transition-colors ${
                                viewMode === 'grid'
            ...
            <div className="flex shrink-0 items-center gap-1.5 border-b border-zinc-800/60 px-3 py-1.5">
                ...
                <input
                    ...
                    aria-label="Search tokens by name, value, or type"
                    className="flex-1 bg-transparent font-mono text-[11px] text-zinc-300 placeholder-zinc-700 outline-none"
                />
                {searchQuery && (
                    <span className="shrink-0 text-[10px] text-zinc-500" aria-live="polite">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
                ...
                {error && !showImport && (
                    <p className="border-t border-red-900/40 bg-red-900/10 px-3 py-2 text-[11px] text-red-400" role="alert">
                        {error}
                    </p>
                )}
            </div>
