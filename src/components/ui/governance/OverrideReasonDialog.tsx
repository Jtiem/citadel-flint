...
export function OverrideReasonDialog({
    ...
    return (
        ...
        >
            <DialogTitle
                id="override-reason-dialog-title"
                sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 2, pr: 2 }}
            >
                <Typography component="span" variant="subtitle1" sx={{ fontWeight: 600, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis' }}>
                    {titleLine}
                </Typography>
                {tier === 'red' ? (
                    <Chip
                        ...
                        color="error"
                        size="small"
                        data-testid="override-tier-chip"
                        aria-label="Reason required for this high-risk override"
                    />
                ) : (
                    <Chip
                        label="Recommended"
                        ...
                        size="small"
                        data-testid="override-tier-chip"
                        aria-label="Reason recommended for this override"
                    />
                )}
            </DialogTitle>
            ...
            <DialogContent dividers>
                {filePath && (
                    <Typography
                        ...
                        data-testid="override-file-path"
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 1.5 }}>
                    {tier === 'red'
                        ? 'This rule blocks export. Record why the override is justified so teammates and auditors can review later.'
                        : 'Leave a short note so teammates know why this rule was waived. This is optional but recommended.'}
                </Typography>

                <TextField
                    inputRef={textareaRef}
                    label="Reason"
                    placeholder="Why are you overriding this rule? (e.g., 'Waived per Legal memo dated 2026-04-10')"
                    multiline
                    maxRows={6}
                    minRows={3}
                    fullWidth
                    ...
                    helperText={
                        reason.length > 0
                            ...
                            : tier === 'red'
                                ? `At least ${MIN_RED_REASON_CHARS} characters required`
                                : ' '
                    }
                />
            </DialogContent>
            ...
            <DialogActions sx={{ px: 3, py: 2, gap: 1 }}>
                ...
                {tier === 'amber' && (
                    <Button
                        ...
                        variant="outlined"
                        color="warning"
                        data-testid="override-without-reason-btn"
                        aria-label="Override without providing a reason"
                    >
                ...
                {tier === 'amber' ? (
                    <Button
                        ...
                        variant="contained"
                        color="warning"
                        disabled={!amberHasReason}
                        data-testid="override-with-reason-btn"
                        aria-label="Override with the reason you typed"
                    >
                    ...
                    <Button
                        ...
                        aria-label="Override this critical issue with the reason you typed"
                    >
                        Override rule
                    </Button>
                )}
