        ...
        <div className="flex flex-col gap-3 p-3">
            ...
            {componentRegistry.map((entry) => (
                <button
                    ...
                    className="flex items-center gap-2.5 rounded-lg border border-gray-700/60 bg-gray-800/50 px-3 py-2.5 text-left transition-colors hover:border-indigo-600/50 hover:bg-gray-700/50"
                >
