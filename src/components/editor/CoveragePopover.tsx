...
export const REASON_LABELS: Record<CoverageReason, string> = {
    ...
    'dynamic-class-expression': "Merges classes dynamically (clsx, cva, classnames) — Flint can't expand these yet",
    'unresolvable-var': "References a CSS variable Flint can't resolve",
    'tailwind-config-extension': "Your Tailwind config extends theme values — Flint doesn't read the config yet",
