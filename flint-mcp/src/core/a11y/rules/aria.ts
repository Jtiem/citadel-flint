/**
 * ARIA rules — flint-mcp/src/core/a11y/rules/aria.ts
 *
...
const rule030: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getFlintId(opening, `${tag}-invalid-role`)
...
const rule031: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const tag = getTagName(path) ?? 'element'
        const elementId = getFlintId(opening, `${tag}-missing-required-children`)
...
const rule032: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const tag = getTagName(path) ?? 'element'
        const elementId = getFlintId(opening, `${tag}-wrong-parent`)
...
const rule033: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const tag = getTagName(path) ?? 'element'
        const elementId = getFlintId(opening, `${tag}-missing-required-attrs`)
...
const rule034: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const tag = getTagName(path) ?? 'element'
        const elementId = getFlintId(opening, `${tag}-invalid-aria-attr`)
...
const rule035: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const tag = getTagName(path) ?? 'element'
        const elementId = getFlintId(opening, `${tag}-invalid-aria-value`)
...
const rule036: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getFlintId(opening, `${tag}-aria-hidden-focusable`)
...
const rule037: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const tag = getTagName(path) ?? 'element'
        const elementId = getFlintId(opening, `${tag}-duplicate-aria`)
...
const rule038: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getFlintId(opening, `${tag}-presentation-role`)
