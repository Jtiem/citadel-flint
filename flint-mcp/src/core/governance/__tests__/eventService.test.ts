...
describe('GovernanceEventService — recordEvent', () => {
    ...
    it('stores optional fields correctly', () => {
        ...
        const [event] = service.queryEvents({})
        expect(event.nodeId).toBe('flint-btn-root')
...
describe('GovernanceEventService — queryEvents filters', () => {
    ...
    beforeEach(() => {
        ...
        service.recordEvent(makeEvent({ id: 'e5', timestamp: '2026-05-01T00:00:00.000Z', ruleId: 'A11Y-002', eventType: 'auto_fix',   severity: 'warning',  filePath: '/b.tsx', actor: 'flint',  sessionId: 's3' }))
    })
