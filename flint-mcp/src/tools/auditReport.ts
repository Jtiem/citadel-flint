/**
 * flint_audit_report MCP tool handler — flint-mcp/src/tools/auditReport.ts
 *
        ...
        properties: {
            ...
            sourceAuthority: {
                ...
                description:
                    ...
                    'Values: "WCAG 2.1 AA", "WCAG 2.2 AA", "SOC2", "FDA SaMD", "HIPAA", "Section 508", "Flint Design System", "Custom".',
            },
        },
...
export function handleAuditReport(args: AuditReportArgs): AuditReportResult {
    ...
    for (const [flintId, warning] of mithrilWarnings) {
