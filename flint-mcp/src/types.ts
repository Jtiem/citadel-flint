...
export interface LinterWarning {
    id: string
    type: 'color-drift' | 'typography-drift' | 'spacing-drift' | 'shadow-drift' | 'opacity-drift' | 'a11y' | 'sync' | 'inline-style-drift' | 'registry' | 'tailwind-version-drift' | 'dark-mode-drift' | 'composition'
