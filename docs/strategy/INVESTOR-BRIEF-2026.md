...
## 2. The Market (2026 Data)

### AI Code Generation is Exploding

| Stat | Source |
|------|--------|
| **41% of all code** written in 2025 is AI-generated | [Multiple sources](https://www.elitebrains.com/blog/aI-generated-code-statistics-2025) |
| **46% of code** in GitHub Copilot-enabled files is AI-generated | [GitHub/CleanAim](https://cleanaim.com/resources/silent-wiring/46-percent-ai-generated-code-quality-challenge/) |
| **92% of developers** use AI tools in some part of their workflow | [Index.dev](https://www.index.dev/blog/developer-productivity-statistics-with-ai-tools) |
| **100% of code** at Anthropic and OpenAI is now AI-written | [Fortune](https://fortune.com/2026/01/29/100-percent-of-code-at-anthropic-and-openai-is-now-ai-written-boris-cherny-roon/) |
| **90% AI-generated code** expected by late 2026 / early 2027 | [Vocal Media](https://vocal.media/futurism/90-code-ai-written-by-2026-reality-check) |
| AI code generation market: **$4.91B** (2024) -> **$30.1B** (2032) | [NetCorp](https://www.netcorpsoftwaredevelopment.com/blog/ai-generated-code-statistics) |

### But AI Code Quality is Terrible

| Stat | Source |
|------|--------|
| AI code introduces **1.7x more total issues** than human code | [Second Talent](https://www.secondtalent.com/resources/ai-generated-code-quality-metrics-and-statistics-for-2026/) |
| **48%** of AI-generated code contains security vulnerabilities | [Second Talent](https://www.secondtalent.com/resources/ai-generated-code-quality-metrics-and-statistics-for-2026/) |
| **45.2%** of developers say debugging AI code takes longer | [Second Talent](https://www.secondtalent.com/resources/ai-generated-code-quality-metrics-and-statistics-for-2026/) |
| **75%** of tech leaders expect moderate-to-severe tech debt from AI-speed practices by 2026 | [Gartner via NetCorp](https://www.netcorpsoftwaredevelopment.com/blog/ai-generated-code-statistics) |

### Accessibility Enforcement is Accelerating

| Stat | Source |
|------|--------|
| **5,114 ADA lawsuits** filed in the US in 2025 | [UsableNet](https://blog.usablenet.com/ada-web-lawsuit-trends-2026) |
| **37% YoY increase** in first half of 2025 | [EcomBack](https://www.ecomback.com/ada-website-lawsuits-recap-report/2025-mid-year-ada-website-lawsuit-report) |
| **5,500+ projected** for 2026 | [BeAccessible](https://beaccessible.com/post/web-accessibility-statistics/) |
| **EU Accessibility Act** in force since June 2025, fines up to **EUR 3M** | [Level Access](https://www.levelaccess.com/compliance-overview/european-accessibility-act-eaa/) |
| **40% increase** in pro se ADA filings, driven by AI-assisted complaint drafting | [Accessible.org](https://accessible.org/2026-ada-website-compliance-lawsuits-ai/) |
| **1,427 repeat lawsuits** -- companies sued again after prior ADA claims | [UsableNet](https://blog.usablenet.com/ada-web-lawsuit-trends-2026) |

### MCP is the Distribution Channel

| Stat | Source |
|------|--------|
| **6,400+ MCP servers** registered as of Feb 2026 | [CData](https://www.cdata.com/blog/2026-year-enterprise-ready-mcp-adoption) |
| MCP adopted by **OpenAI, Google, Microsoft, Amazon, Anthropic** | [Pento](https://www.pento.ai/blog/a-year-of-mcp-2025-review) |
| MCP market expected to reach **$1.8B** in 2025 | [CData](https://www.cdata.com/blog/2026-year-enterprise-ready-mcp-adoption) |
| **Figma MCP server** live, generates design layers from VS Code | [GitHub Blog](https://github.blog/changelog/2026-03-06-figma-mcp-server-can-now-generate-design-layers-from-vs-code/) |
| Integrated in **VS Code, Cursor, Windsurf, Claude Code** | [Figma Blog](https://www.figma.com/blog/introducing-figma-mcp-server/) |

### Design Systems are Universal but Unenforced
...
| Anima/Locofy | None | None | None | Yes | No | N/A | None |
...
1. **The AI Code Flood.** 41% today, 90% by 2027. Every line of AI-generated JSX with a hardcoded color is a governance failure. Manual review is impossible at this volume.
...
## 7. Metrics Investors Will Ask For

**Product signals (verified, March 2026):**

| Metric | Count | Notes |
|--------|-------|-------|
| MCP tools registered | 10 | Headless governance engine |
| MCP resources | 4 | Live state exposure (tokens, manifest, rules, violations) |
| MCP prompts | 2 | Governance persona + intent composer |
| AI Orchestrator tools | 11 | Read, mutate, audit ops in constrained catalog |
| WCAG 2.1 AA rules | 10 | Deterministic AST-level checks |
| Mithril rule categories | 6 | Color (CIEDE2000), typography, spacing, shadow, opacity, composite |
| Zustand stores | 9 | Zero cross-store contamination |
| React components | 41 | Glass observability layer |
| IPC channels | 48 | Electron process boundary surface |
| Production modules | 43 | All status: ONLINE |
...
- Design debt score improvement over time
...
|  2 Prompts: governance AI     |    |  Governance overlays          |
|                               |    |  Design debt dashboard        |
|  Runs in: CI, IDE, cloud      |    |  Reads MCP state, no logic    |
+-------------------------------+    +-------------------------------+
            |                                    |
            +---- stdio / MCP protocol ----------+
```
...
## 9. Roadmap Signal (Next 2 Quarters)

Three waves of UX gap-fill to move JTBD completeness from 7.5 to 9.0:

| Wave | What ships | Why it matters |
|------|-----------|---------------|
...
- Healthcare UI (HIPAA, Section 508)
- Financial services (PCI DSS display requirements)
- Government (Section 508, VPAT)

---

## 10. Recommended Pitch Arc
...
8. **Show the architecture:** Two-component diagram. Headless engine = revenue. Glass = retention.
9. **Show expansion:** Same engine, new domains -- IaC, healthcare, government, fintech.
10. **Close with team + ask.**

---

## Sources

- [AI Code Generation Statistics 2026](https://www.netcorpsoftwaredevelopment.com/blog/ai-generated-code-statistics)
- [100% of Code at Anthropic/OpenAI is AI-Written (Fortune)](https://fortune.com/2026/01/29/100-percent-of-code-at-anthropic-and-openai-is-now-ai-written-boris-cherny-roon/)
- [46% AI-Generated Code Quality Challenge](https://cleanaim.com/resources/silent-wiring/46-percent-ai-generated-code-quality-challenge/)
...
- [90% Code AI Written Reality Check](https://vocal.media/futurism/90-code-ai-written-by-2026-reality-check)
- [AI Coding Everywhere (MIT Tech Review)](https://www.technologyreview.com/2025/12/15/1128352/rise-of-ai-coding-developers-2026/)
- [ADA Lawsuit Trends 2026 (UsableNet)](https://blog.usablenet.com/ada-web-lawsuit-trends-2026)
- [ADA Lawsuits Surge 37% (PRNewswire)](https://www.prnewswire.com/news-releases/2025-mid-year-report-ada-website-accessibility-lawsuits-surge-37-as-litigation-expands-nationwide-302541655.html)
- [2026 ADA Compliance Predictions](https://accessible.org/2026-ada-website-compliance-lawsuits-ai/)
- [European Accessibility Act Compliance](https://www.levelaccess.com/compliance-overview/european-accessibility-act-eaa/)
- [EAA What's Next 2026](https://getwcag.com/en/blog/european-accessibility-act-whats-next-in-2026)
...
- [Figma MCP Server (GitHub Blog)](https://github.blog/changelog/2026-03-06-figma-mcp-server-can-now-generate-design-layers-from-vs-code/)
...
- [Anysphere Raises $1.1B](https://www.elitebrains.com/blog/aI-generated-code-statistics-2025)
