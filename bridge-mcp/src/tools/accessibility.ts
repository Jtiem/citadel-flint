/**
 * bridge_accessibility_report tool handler — bridge-mcp/src/tools/accessibility.ts
 *
 ...
 *
 * This is a dedicated tool separate from bridge_audit, optimized for
...
export const BRIDGE_ACCESSIBILITY_REPORT_TOOL = {
    name: 'bridge_accessibility_report',
    description:
