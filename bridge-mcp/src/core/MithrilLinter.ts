/**
 * MithrilLinter — bridge-mcp/src/core/MithrilLinter.ts
 *
 ...
 * Map<bridgeId, LinterWarning>. Color drift takes precedence over other
 * dimensions (first-write wins per node).
 */
export function auditAll(ast: File, tokens: DesignToken[], options?: PolicyOptions): Map<string, LinterWarning> {
