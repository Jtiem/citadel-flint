/**
 * Policy Engine — bridge-mcp/src/core/policyEngine.ts
 *
 * Pure functions for resolving and evaluating Bridge governance policy.
...
/**
 * Loads `.bridge/policy.json` from the given project root.
