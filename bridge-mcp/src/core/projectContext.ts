/**
 * projectContext.ts — bridge-mcp/src/core/projectContext.ts
 *
 * Lightweight project health context loader for CX.1 Response Quality Baseline.
 *
 * Data source: .bridge/debt-history.json — reads the most recent entry (O(1) read).
...
/**
 * Shape of an entry in .bridge/debt-history.json.
...
/**
 * Load project-level health context from .bridge/debt-history.json.
 *
 * Data source priority:
 *   1. .bridge/debt-history.json — reads the most recent entry (O(1) file read)
