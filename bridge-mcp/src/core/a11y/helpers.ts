/**
 * A11y helpers — bridge-mcp/src/core/a11y/helpers.ts
 *
...
/**
 * Returns the `data-bridge-id` value for an element, or the provided fallback.
 */
export function getBridgeId(opening: JSXOpeningElement, fallback: string): string {
