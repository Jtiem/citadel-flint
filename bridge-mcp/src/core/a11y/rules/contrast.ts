/**
 * Contrast rules — bridge-mcp/src/core/a11y/rules/contrast.ts
 *
...
const rule060: A11yRule = {
    ...
    visitElement(path, context) {
        ...
        const elementId = getBridgeId(opening, `${tag}-contrast-normal`)
...
const rule061: A11yRule = {
    ...
    visitElement(path, context) {
        ...
        const elementId = getBridgeId(opening, `${tag}-contrast-large`)
...
const rule062: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, `${tag}-non-text-contrast`)
