/**
 * Names and Labels rules — bridge-mcp/src/core/a11y/rules/names-labels.ts
 *
...
import type { A11yRule, A11yRuleContext, A11yViolationDetail, A11yFixResult } from '../types.js'
import {
    getBridgeId,
    getTagName,
    getJsxAttr,
...
const rule001: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, `img-missing-alt`)
        return {
            ruleId: 'A11Y-001',
            elementId,
            message:
...
const rule002: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'button-no-name')
        return {
            ruleId: 'A11Y-002',
            elementId,
            message:
...
const rule003: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'a-no-name')
        return {
            ruleId: 'A11Y-003',
            elementId,
            message:
...
const rule004: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'input-no-label')
        return {
            ruleId: 'A11Y-004',
            elementId,
            message:
...
const rule005: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'select-no-label')
        return {
            ruleId: 'A11Y-005',
            elementId,
            message:
...
const rule006: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'textarea-no-label')
        return {
            ruleId: 'A11Y-006',
            elementId,
            message:
...
const rule011: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'img-filename-alt')
        return {
            ruleId: 'A11Y-011',
            elementId,
            message:
...
const rule012: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'svg-no-name')
        return {
            ruleId: 'A11Y-012',
            elementId,
            message:
...
const rule013: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'input-image-no-alt')
        return {
            ruleId: 'A11Y-013',
            elementId,
            message:
...
const rule014: A11yRule = {
    ...
    visitElement(path, _context) {
        ...
        const elementId = getBridgeId(opening, 'a-generic-text')
        return {
            ruleId: 'A11Y-014',
            elementId,
            message:
