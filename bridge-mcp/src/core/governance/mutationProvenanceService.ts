/**
 * MutationProvenanceService — bridge-mcp/src/core/governance/mutationProvenanceService.ts
 *
 * Records and queries WHO or WHAT caused each AST mutation:
 *   - 'human'     — direct Bridge Glass UI interaction
 *   - 'agent'     — AI agent via bridge_ast_mutate MCP tool
