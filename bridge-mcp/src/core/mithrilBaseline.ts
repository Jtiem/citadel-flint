/**
 * MithrilBaselineService — bridge-mcp/src/core/mithrilBaseline.ts
 *
 * SQLite-backed baseline snapshot service for Mithril Delta Mode (MDA.1).
 *
 * Problem context: teams adopting Bridge mid-project see 200+ existing
 ...
 *   - id      — the bridge node ID (data-bridge-id attribute value)
