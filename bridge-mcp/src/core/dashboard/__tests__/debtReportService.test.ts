/**
 * DebtReportService tests — bridge-mcp/src/core/dashboard/__tests__/debtReportService.test.ts
 *
...
export const Card = () => (
  <div data-bridge-id="card-root">
    <img data-bridge-id="card-img" src="logo.png" alt="Logo" />
    <button data-bridge-id="card-btn" aria-label="Submit">Submit</button>
  </div>
);
`
...
export const Drifted = () => (
  <div data-bridge-id="drift-root" className="bg-[#ff00ff] text-[#00ff00]">
...
import React from 'react';
export const Mixed = () => (
  <div data-bridge-id="mixed-root" className="bg-[#aabbcc]">
    <img data-bridge-id="mixed-img" src="photo.png" />
    <button data-bridge-id="mixed-btn"></button>
  </div>
);
`
...
describe('generateDebtReport', () => {
    ...
    it('returns a perfect score for a clean project', () => {
        ...
        writeFile('.bridge/design-tokens.json', JSON.stringify(MOCK_TOKENS))
    ...
    it('detects A11y violations', () => {
        ...
        writeFile('.bridge/design-tokens.json', '[]')
...
describe('debt history tracking', () => {
    ...
    it('creates debt-history.json when track=true', () => {
        ...
        const historyPath = path.join(tmpDir, '.bridge', 'debt-history.json')
    ...
    it('rotates history at 100 entries', () => {
        ...
        fs.writeFileSync(
            path.join(tmpDir, '.bridge', 'debt-history.json'),
