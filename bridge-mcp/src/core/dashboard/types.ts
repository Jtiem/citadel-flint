/**
 * Design Debt Report types — bridge-mcp/src/core/dashboard/types.ts
 *
 * Shared type definitions for the DebtReportService, the bridge_debt_report
 * MCP tool, and the bridge://dashboard resource. Used by EXP.2 (Design Debt
...
/**
 * A compact snapshot appended to .bridge/debt-history.json on each tracked
...
/**
 * The payload returned by the bridge://dashboard resource. Combines the
